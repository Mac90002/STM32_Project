#if !defined(__BSP_ESP8266_H)
#define __BSP_ESP8266_
...
/********************************** 用户需要设置的参数**********************************/
#define macUser_ESP8266_ApSsid 				"TP-LINK_7A22" // 要连接的热点的名称
#define macUser_ESP8266_ApPwd 				"skd12314"	  // 要连接的热点的密钥

#define macUser_ESP8266_TcpServer_IP 		"iot-06z00hjdct1op8z.mqtt.iothub.aliyuncs.com" // 要连接的服务器的 IP
#define macUser_ESP8266_TcpServer_Port 		"1883"										// 要连接的服务器的端口

#define clientId 				"iv8n2SoV9vD.D001|securemode=2\,signmethod=hmacsha256\,timestamp=1686470359847|"
#define username 				"D001&iv8n2SoV9vD"
#define passwd 					"95b13bd424fe6b35e719444aa1865e15d44b4bcaccf44cbf3fb8fa4e57973aad"
...
/******************************* ESP8266 外部全局变量声明 ***************************/
#define RX_BUF_MAX_LEN 1500 // 最大接收缓存字节数
...
void WiFi_SendString(uint8_t *str, int counter);
